...
baseurl = 'http://nonton.to' #'http://layarkaca21.tv' #'http://layarkaca21.com' #'http://www.nonton.mobi/
...
def LINK(name,url,iconimage):
        title = url.replace('http://nonton.to','').replace('http://layarkaca21.tv/','').replace('/','')
        mplay = baseurl+'/movie/out.php?movie='
        url = url + '0/'
        link = OPEN_URL(url)
