...
##-- PressPlay add-on's debrid cache check module adjusted for PressPlay/PressPlay code base - all credits to PressPlay --##
...
__r_url__ = control.addon('script.module.urlresolver')
...
class ADapi:
    def __init__(self):
        ...
        self.user_agent = 'PressPlay for Kodi'
