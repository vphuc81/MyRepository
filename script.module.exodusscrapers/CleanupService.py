# -*- coding: utf-8 -*-
# ExodusScrapers Cleanup Service
...
from lib.exodusscrapers import getAllHosters
from lib.exodusscrapers import providerSources
...
try:
    ...
    # Reset obsolete module providers to ExodusScrapers.
    if ADDON.getSetting('module.provider') not in providerSources():
        ADDON.setSetting('module.provider', ' ExodusScrapers')
except:
    pass
