...
if action == None:
    from resources.lib.indexers import supremacy
    try:
     supremacy.d()
    except:
     pass
    ...
    from resources.lib.indexers import supremacy
    supremacy.indexer().get(url)

elif action == 'parental':
    from resources.lib.indexers import supremacy
    supremacy.indexer().parental_controls()

elif action == 'qdirectory':
    from resources.lib.indexers import supremacy
    supremacy.indexer().getq(url)

elif action == 'xdirectory':
    from resources.lib.indexers import supremacy
    supremacy.indexer().getx(url)

elif action == 'developer':
    from resources.lib.indexers import supremacy
    supremacy.indexer().developer()

elif action == 'tvtuner':
    from resources.lib.indexers import supremacy
    supremacy.indexer().tvtuner(url)

elif 'youtube' in str(action):
    from resources.lib.indexers import supremacy
    supremacy.indexer().youtube(url, action)

elif action == 'play':
    from resources.lib.indexers import supremacy
    supremacy.player().play(url, content)

elif action == 'browser':
    from resources.lib.indexers import supremacy
    supremacy.resolver().browser(url)

elif action == 'search':
    from resources.lib.indexers import supremacy
    supremacy.indexer().search()

elif action == 'addSearch':
    from resources.lib.indexers import supremacy
    supremacy.indexer().addSearch(url)

elif action == 'delSearch':
    from resources.lib.indexers import supremacy
    supremacy.indexer().delSearch()
