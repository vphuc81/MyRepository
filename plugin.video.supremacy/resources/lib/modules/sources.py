...
class sources:
        ...
        for i in range(0, (timeout * 2) + 60):
            try:
                ...
                try:
                    ...
                    pass
                try:
                    string4 = "We are searching multiple websites and gathering links for: [COLORyellow][B]%s (%s)[/COLOR][/B] - Time Elapsed: [COLOR red]%s Seconds[/COLOR]"  % (title,year,str(timerange))
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.supremacy.container.items'

        self.metaProperty = 'plugin.video.supremacy.container.meta'
