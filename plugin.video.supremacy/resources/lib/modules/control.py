...
def artPath():
    path = xbmc.translatePath('special://home/addons/plugin.video.supremacy/')
    return path
...
def moderator():
	import xbmc
	xbmc.log('Welcome to Supremacy')


def metaFile():
    path = xbmc.translatePath('special://home/userdata/addon_data/plugin.video.supremacy/meta')
    return path
