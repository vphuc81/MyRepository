...
if 64 - 64: i11iIiiIii
OO0o = 'plugin.video.kodi4vn.yeuphim'
...
def ooO0OO000o ( ) :
 ...
 oOooOoO0Oo0O = urllib2 . urlopen ( "http://www.viettv24.com/main/checkActivation.php?MacID=%s&app_id=%s" % ( ii11i , "17" ) ) . read ( )
 ...
 if 49 - 49: urllib . urlretrieve ( 'https://googledrive.com/host/0B-ygKtjD8Sc-S04wUUxMMWt5dmM/images/yeuphim.jpg' , IiI1ii1 )
...
if oOooOOOoOo == 'index' :
 ...
 Iiii1i1 . create ( 'YeuPhim' , 'Loading video. Please wait...' )
