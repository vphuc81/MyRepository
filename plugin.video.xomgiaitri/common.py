...
#############################################################################
__settings__ = xbmcaddon.Addon(id='plugin.video.xomgiaitri')
#__icon__ = xbmcaddon.Addon(id='plugin.video.kodi4vn.xomgiaitri').getAddonInfo('icon')
...
def encode64x2(code):
	try:
		return base64.b64encode(base64.b64encode(code))
	except: return code
	
def decode64x2(code):
	try:
		return base64.b64decode(base64.b64decode(code))
	except: return code
#############################################################################
#############################################################################
...
addonInfo = xbmcaddon.Addon#(id='plugin.video.iptvnow').getAddonInfo("name")
#addonInfo = xbmcaddon.Addon(id='plugin.video.SportsDevil').getAddonInfo('name')
