...
class main():
    ...
    def categories(self):
        cats = [('http://wizhdsports.com/sports/Football.html','Football','icons/soccer.png'),('http://wizhdsports.com/sports/NFL.html','American Football','icons/football.png'),
    ...
    def __prepare_links(self,links):
        new=[]
        for link in links:
            title = link.getText().replace('()','').strip()
            url = link['href']
