    ...
    if len(names) == 1:
        ...
        for item in items:
            ...
            if ("redirecttomovieshd" in link) or ("toyeuphim" in link) or ("redirecttonetmovie" in link) or \
               ...
               ("tomic" in link) or ("tohappymovies" in link) or ("tosureshot" in link) or ("tomdyesmovies" in link) or ("toicefilms" in link) or ("tovtvgo" in link) or ("tophimltv137" in link) \
               ("tozen" in link) or ("tometalliq" in link) or ("tobob" in link):
                link = re.compile('<link>(.+?)</link>').findall(item)[0]            
