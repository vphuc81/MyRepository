...
#############################################################################
__settings__ = xbmcaddon.Addon(id='plugin.video.vtvgolive')
...
def decB64(link):
	try: return urllib2.base64.b64deccode(link) #link.decode('base-64')
	except: return link
def encB64(link):
	try: return urllib2.base64.b64encode(link) #link.encode('base-64')
	except: return link
#############################################################################
#############################################################################
...
addonInfo = xbmcaddon.Addon(id='plugin.video.vtvgolive').getAddonInfo("name")
