...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en']
        self.domains = ['www.uwatchfree.tv']
        self.base_link = 'http://www.uwatchfree.tv'
        ...
        try:
            ...
            for link in links:
                try:
                    ...
                    for i in r:
                        try: sources.append({'source': host, 'quality': SD, 'language': 'en', 'url': i, 'direct': True, 'debridonly': False})
                        except: pass
                except:
                    pass
