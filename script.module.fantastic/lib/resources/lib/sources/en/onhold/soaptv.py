...
class source:
    def __init__(self):
        ...
        self.search_link = 'https://9mmovies.come/index.php?do=search'
        self.headers = {'referer':'https://xmovies8.es'}
    ...
    def episode(self, url, imdb, tvdb, title, premiered, season, episode):
        with requests.Session() as s:
            try:
                ...
                sources.append(
                    {'source': host, 'quality': 'SD', 'language': 'en', 'url': p.url, 'direct': False, 'debridonly': True})
                return sources
