                    ...
                    for n in range(3):
                        try:
                            ...
                            if type(src) is list:
                                ...
                                for i in src:
                                    try:
                                        sources.append({'source': host, 'quality': directstream.googletag(i)[0]['quality'], 'language': 'en', 'url': i, 'direct': True, 'debridonly': False})
                                    except:
                                        pass
                            else:
                                ...
                                sources.append({'source': host, 'quality': 'SD', 'language': 'en', 'url': src, 'direct': False, 'debridonly': False})
                        except:
                            pass
                except:
                    pass
