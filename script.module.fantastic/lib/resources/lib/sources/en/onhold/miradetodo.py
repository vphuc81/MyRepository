            ...
            for u in f:
                try:
                    ...
                    if 'stream/ol.php' in u:
                        ...
                        sources.append({'source': 'openload.co', 'quality': 'SD', 'language': 'en', 'url': url, 'direct': False, 'debridonly': False})
                    ...
                    if 'stream/play.php' in u:
                        ...
                        for i in links:
                            try:
                                ...
                                elif 720 <= int(quality) < 1080: quality = 'SD',
                                else: quality = 'SD',
                                ...
                                sources.append({'source': 'gvideo', 'quality': 'SD', 'language': 'en', 'url': i['file'], 'direct': True, 'debridonly': False})
                            except:
                                pass
                except:
                    pass
