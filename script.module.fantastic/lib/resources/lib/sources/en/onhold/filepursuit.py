'''
    ...
    source from Fantastic regardless to the fact that the cloudflare security
...
class source:
    ...
    def __init__(self):
        ...
        self.search_link = 'https://xmovies8.es/search/'

    def tvshow(self, imdb, tvdb, tvshowtitle, localtvshowtitle, aliases, year):
        try:
            url = tvshowtitle.replace(' ', '-')
        except:
            print("Unexpected error in xmovies8.es Script: TV", sys.exc_info()[0])
            return url
        return url
    ...
    def episode(self, url, imdb, tvdb, title, premiered, season, episode):
        try:
            ...
            print("Unexpected error in xmovies8.es Script: episode", sys.exc_info()[0])
