        ...
        try:
            ...
            for page in pages:
                try:
                    ...
                    if valid: sources.append({'source': host, 'quality': 'SD', 'language': 'en', 'url': url, 'direct': False, 'debridonly': False})
                    ...
                    for 'SD', url in result: sources.append({'source': 'gvideo', 'quality': 'SD', 'language': 'en', 'url': url, 'direct': True, 'debridonly': False})
                except:
                    pass
