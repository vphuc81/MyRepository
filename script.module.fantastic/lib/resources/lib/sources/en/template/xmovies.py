...
class source:
    def __init__(self):
        ...
        self.base_link = 'http://xmovies8.es'
		self.base_link_2 = 'https://xmovies8.es'
    ...
    def sources(self, url, hostDict, hostprDict):
        try:
            ...
            sources.append({'source': host, 'quality': 'HD', 'language': 'en', 'url': source, 'direct': True, 'debridonly': False})
