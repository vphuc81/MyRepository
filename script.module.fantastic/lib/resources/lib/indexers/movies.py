...
class movies:
    def __init__(self):
        ...
        self.oscars_link = 'http://www.imdb.com/search/title?title_type=feature&release_date=1975-01-01,2017-12-31&groups=top_1000&sort=release_date,desc&count=40&start=1'
